...
import romanow.abc.ess2.android.lep500.I_ListBoxListener;
import romanow.abc.ess2.android.lep500.ListBoxDialog;
import romanow.abc.ess2.android.lep500.MainActivity;
import romanow.abc.ess2.android.lep500.MultiListBoxDialog;
import romanow.abc.ess2.android.lep500.MultiListBoxListener;
import romanow.abc.ess2.android.lep500.service.AppData;
import romanow.abc.ess2.android.lep500.service.NetBackDefault;
...
public class MIDownLoad extends MenuItem {
    ...
    public MIDownLoad(MainActivity main0) {
        ...
        main.addMenuList(new MenuItemAction("Загрузка с сервера") {
            @Override
