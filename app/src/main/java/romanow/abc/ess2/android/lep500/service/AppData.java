...
import romanow.abc.ess2.android.lep500.LoginSettings;
import romanow.abc.ess2.android.lep500.StoryList;
...
public class AppData extends Application {
    ...
    public final static HashMap<Integer,Integer> StateColors=new HashMap<>();{
        ...
        StateColors.put(Values.MSNoise,R.drawable.status_red);
        StateColors.put(Values.MSLowLevel,R.drawable.status_red);
